      ...
      <Modal visible={showOptionsModal} transparent animationType="slide">
        <View style={styles.optionsOverlay}>
          <View style={styles.optionsBox}>
            ...
            <Text style={styles.optionsTitle}>Tùy chọn trận đấu</Text>
            
            <TouchableOpacity 
              style={styles.optionBtn} 
              onPress={() => { setShowOptionsModal(false); handleEdit(); }}
            >
              <Text style={styles.optionBtnText}>✏️ Sửa trận đấu</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={styles.optionBtnDanger}>🗑️ Xóa trận đấu</Text>
            </TouchableOpacity>
